...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
	 ...
	 * The game settings.
	 */
   public static GameSetting SETTINGS = new GameSetting(GameLaunch.SETTINGS.getName(), Configurations.LOCAL_MS ? "127.0.0.1" : "192.168.1.74"/*"192.168.1.74"*/, 1, "live", false, false);
