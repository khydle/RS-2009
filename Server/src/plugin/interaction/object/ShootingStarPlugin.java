...
public class ShootingStarPlugin extends OptionHandler {
	...
	public enum ShootingStar {
		LEVEL_1(38668, 14, 200, 0.05),
		LEVEL_2(38667, 25, 140, 0.1),
		LEVEL_3(38666, 29, 80, 0.3),
		LEVEL_4(38665, 32, 70, 0.44),
		LEVEL_5(38664, 47, 60, 0.45),
		LEVEL_6(38663, 71, 50, 0.46),
		LEVEL_7(38662, 114, 40, 0.47),
		LEVEL_8(38661, 145, 25, 0.48),
		LEVEL_9(38660, 210, 15, 0.49);
