...
public final class ModernTeleportPlugin extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		...
		// house
		SpellBook.MODERN.register(23, new HouseTeleportPlugin(40, 0));
		// ardougne
		...
		// ape atol
		SpellBook.MODERN.register(47, new ModernTeleportPlugin(64, 5, Location.create(2754, 2784, 0), new Item(1963, 1)));
		return this;
	}
