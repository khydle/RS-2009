...
public final class AncientTeleportPlugin extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		...
		// paddewwa teleport
		SpellBook.ANCIENT.register(20, new AncientTeleportPlugin(54, 0, Location.create(3098, 9882, 0)));
		// sennisten teleport
		SpellBook.ANCIENT.register(21, new AncientTeleportPlugin(60, 0, Location.create(3320, 3338, 0)));
		// karyll teleport
		SpellBook.ANCIENT.register(22, new AncientTeleportPlugin(66, 0, Location.create(3493, 3472, 0)));
		// lassar teleport
		SpellBook.ANCIENT.register(23, new AncientTeleportPlugin(72, 0, Location.create(3003, 3470, 0)));
		// dareeyak teleport
		SpellBook.ANCIENT.register(24, new AncientTeleportPlugin(78, 0, Location.create(2966, 3696, 0)));
		// carralangar teleport
		SpellBook.ANCIENT.register(25, new AncientTeleportPlugin(84, 0, Location.create(3163, 3664, 0)));
		// annakarl teleport
		SpellBook.ANCIENT.register(26, new AncientTeleportPlugin(90, 0, Location.create(3287, 3883, 0)));
		// ghorrock teleport
		SpellBook.ANCIENT.register(27, new AncientTeleportPlugin(96, 0, Location.create(2972, 3873, 0)));
		return this;
	}
